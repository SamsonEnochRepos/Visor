...
class Pipeline:
    ...
    def __init__(self, shared_state: Dict[str, Any],
        ...
        # --- Perception ---
        # This file is at <root>/src/visor/core/pipeline.py
        script_dir = os.path.dirname(os.path.abspath(__file__))          # .../src/visor/core
        project_root = os.path.dirname(os.path.dirname(os.path.dirname(script_dir)))  # project root
